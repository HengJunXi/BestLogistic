...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="row mt-3">
            ...
            <script>
                ...
                function initMap() {
                    ...
                    directionsService.route({
                        origin: {
                            placeId: 'ChIJleOtcJZLzDERT8y4frIc0wk'
                        },
                        destination: {
                            placeId: 'ChIJ7ZqvbEzKzTER-r67V-ufxtg'
                        },
                ...
                function addMarkers(directionResult) {
            ...
            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAEtyK6nyFUnMLqFoi72ZWxBc5-QImhFnM&callback=initMap"
            async defer></script>
